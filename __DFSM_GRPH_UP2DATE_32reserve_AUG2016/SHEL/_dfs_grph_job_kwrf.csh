...
#KWRF 
    java -classpath .:$JDOM_HOME/build/jdom.jar:$parserABSPath RawData_ToXML $stn_kwrf_pop $stn_kwrf_reh $stn_kwrf_rn3 $stn_kwrf_sn3 $stn_kwrf_sky $stn_kwrf_pty $stn_kwrf_r12 $stn_kwrf_s12
