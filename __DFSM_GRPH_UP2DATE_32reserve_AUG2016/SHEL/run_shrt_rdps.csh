...
pwd
echo "Sky ncl run" 
ncl grid_sky.ncl $cmd_rdp & 
echo "Pop ncl run" 
ncl grid_pop.ncl $cmd_rdp &
echo "Tmp ncl run" 
ncl grid_tmp.ncl $cmd_rdp &
echo "Rain 3hour ncl run" 
ncl grid_pop_rain.ncl $cmd_rdp  &
echo "Pty ncl run" 
ncl grid_pty.ncl $cmd_rdp  &
echo "RH ncl run" 
ncl grid_rh.ncl $cmd_rdp &
echo "Wind ncl run" 
ncl grid_wind.ncl $cmd_rdp &
echo "Snow ncl run" 
ncl grid_sn3.ncl $cmd_rdp &
